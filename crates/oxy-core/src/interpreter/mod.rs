//! Tree-walking interpreter for the Oxy language.
//!
...
/// Convenience function: parse and execute a Oxy program.
...
/// Parse and execute a Oxy program from a file path (enables module resolution).
...
/// Parse and execute a Oxy program from a file path with CLI args.
...
/// Discover and run `#[test]` functions in a Oxy source file.
