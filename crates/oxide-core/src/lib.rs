//! Oxide — Rust syntax, scripting freedom.
//!
//! Core library for the Oxide programming language interpreter.
//! Oxide replicates Rust's syntax without the borrow checker or ownership rules.
...
mod tests {
    ...
    fn test_version_string() {
        ...
        assert!(version.starts_with("Oxide v"));
