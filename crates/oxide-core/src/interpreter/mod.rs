...
pub(crate) struct ModuleData {
    ...
    pub(crate) trait_impls: HashMap<(String, String), Vec<FnDef>>,
}
...
impl Interpreter {
    ...
    // register_item, register_module, load_module_file, register_use,
    // import_item_from_module, import_all_from_module moved to register.rs

    // eval_stmt moved to eval/stmt.rs, eval_block moved to eval/block.rs
