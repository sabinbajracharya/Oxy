...
fn main() {
    io::println("{}", length_of_longest_substring("abcabcbb"));
    io::println("{}", length_of_longest_substring("bbbbb"));
}
...
#[test]
fn test_example() {
    assert::eq(length_of_longest_substring("abcabcbb"), 3);
}

#[test]
fn test_all_same() {
    assert::eq(length_of_longest_substring("bbbbb"), 1);
}

#[test]
fn test_empty() {
    assert::eq(length_of_longest_substring(""), 0);
}

#[test]
fn test_single() {
    assert::eq(length_of_longest_substring("a"), 1);
}

#[test]
fn test_pwwkew() {
    assert::eq(length_of_longest_substring("pwwkew"), 3);
}
