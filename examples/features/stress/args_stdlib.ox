...
fn test_program_extracted() {
    let a = std::args::parse_from(["script.ox".to_string()]);
...
fn test_long_flag_presence_only() {
    let a = std::args::parse_from(["p".to_string(), "--verbose".to_string()]);
...
fn test_long_flag_with_value() {
    let a = std::args::parse_from(["p".to_string(), "--name=alice".to_string()]);
    assert_eq(a.flags.get("name").unwrap(), "alice");
}

#[test]
fn test_short_flag_with_value() {
    let a = std::args::parse_from(["p".to_string(), "-k=v".to_string()]);
    assert_eq(a.flags.get("k").unwrap(), "v");
}

#[test]
fn test_short_flag_presence() {
    let a = std::args::parse_from(["p".to_string(), "-v".to_string()]);
...
fn test_bare_dash_is_positional() {
    let a = std::args::parse_from(["p".to_string(), "-".to_string()]);
...
fn test_value_with_embedded_equals() {
    let a = std::args::parse_from(["p".to_string(), "--query=a=b=c".to_string()]);
